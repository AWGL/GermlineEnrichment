...
if df_unfiltered.shape[1] == 0:
	...
	df_unfiltered['RunAlleleCount'] = df_unfiltered['info_AC']
	df_unfiltered['Clinvar'] = df_unfiltered['csq_CLIN_SIG']
	df_unfiltered['AutoTranscriptPick'] = df_unfiltered['csq_PICK']
	df_unfiltered['AcceptorGainProb'] = df_unfiltered['csq_SpliceAI_DS_AG']
	df_unfiltered['AcceptorLossProb'] = df_unfiltered['csq_SpliceAI_DS_AL']
	df_unfiltered['DonorGainProb'] = df_unfiltered['csq_SpliceAI_DS_DG']
	df_unfiltered['DonorLossProb'] = df_unfiltered['csq_SpliceAI_DS_DL']
...
if df_filtered.shape[1] == 0:
	...
	df_filtered['RunAlleleCount'] = df_filtered['info_AC']
	df_filtered['Clinvar'] = df_filtered['csq_CLIN_SIG']
	df_filtered['AutoTranscriptPick'] = df_filtered['csq_PICK']
	df_filtered['AcceptorGainProb'] = df_filtered['csq_SpliceAI_DS_AG']
	df_filtered['AcceptorLossProb'] = df_filtered['csq_SpliceAI_DS_AL']
	df_filtered['DonorGainProb'] = df_filtered['csq_SpliceAI_DS_DG']
	df_filtered['DonorLossProb'] = df_filtered['csq_SpliceAI_DS_DL']
